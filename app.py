...
-----------------------------------------------------------------
Version with Hugging Face integration for model artifacts
"""
...
# ==========================================================================
# Loading Artifacts from Hugging Face (مع التعديل)
# ==========================================================================
    ...
    for key, filename in ARTIFACT_SUFFIXES.items():
        try:
            path = hf_hub_download(
                repo_id=HF_REPO_ID,
                filename=filename,
                repo_type="model"  # ✅ التعديل المطلوب
            )
...
def page_about():
    ...
    with col2:
        ...
        <div class="about-section">
            ...
            <h3>🤖 Model</h3>
            <p>
            Machine Learning model with preprocessing
...
try:
    ...
    st.error("Please make sure the repository 'saifalaswad/electricity-consumption-model' exists.")
    st.code(str(e))
    st.stop()
...
st.sidebar.caption("Model hosted on HF Hub")
